...
def test_svdmg_import():
    try:
        from bm3dornl import svdmg
    except ImportError:
        pytest.fail("Could not import bm3dornl.svdmg module")

def test_svdmg_execution():
    from bm3dornl import svdmg
    ...
    # Run SVDMG
    corrected = svdmg.svd_streak_removal(img)
...
def test_svdmg_wall_protection():
    from bm3dornl import svdmg
